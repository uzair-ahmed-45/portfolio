            ...
            <div className='bg-[rgba(2,24,42,255)] py-24 px-24 '>
                ...
                <div className='flex flex-wrap justify-center mt-12 gap-10'>
                    <div className='py-16 bg-[rgba(18,27,42,255)] px-12 rounded-2xl cursor-pointer servicebox w-[80vw] md:w-[40vw] flex flex-col ' data-aos="flip-right">
                        ...
                        <p className='text-gray-300 text-sm md:text-md mt-2'>I'm passionate web developer dedicated to crafting stunning online experiences. With expertise in front-end and back-end technologies, I offer comprehensive web development services tailored to your needs. Let's collaborate to bring your vision to life and elevate your online presence.</p>
                    </div>
                    <div className='py-16 bg-[rgba(18,27,42,255)] px-12 rounded-2xl cursor-pointer servicebox w-[80vw] md:w-[40vw] flex flex-col ' data-aos="flip-left">
                        ...
                        <p className='text-gray-300 text-sm md:text-md mt-2'>I provide expert MERN stack development services, crafting robust web solutions tailored to your unique business needs. With a focus on efficiency and innovation, I deliver dynamic applications that leverage the power of MongoDB, Express.js, React, and Node.js. Let me elevate your online presence with seamless, scalable, and secure solutions, driving your digital success forward.</p>
                    </div>
                    <div className='py-16 bg-[rgba(18,27,42,255)] px-12 rounded-2xl cursor-pointer servicebox w-[80vw] md:w-[40vw] flex flex-col ' data-aos="flip-up">
