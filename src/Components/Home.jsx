            ...
            <div className='flex justify-center text-center items-center py-24 px-20 relative  md:mt-[-50px] ' id='home'>
                ...
                <div className='w-[80vw] md:w-[50vw] flex flex-col gap-5 md:gap-8 mt-5' data-aos="fade-up">
                    ...
                    <div>
                        ...
                        <a href='/2025Resume.pdf' target='blank' className='bt px-4 py-2 font-small text-lg text-[rgb(122,182,228)] ms-4 rounded-xl hover:bg-[rgb(122,182,228)] hover:text-white' style={{ border: '1px solid rgb(122,182,228)' }}>Download CV</a>
                    </div>
                </div>
