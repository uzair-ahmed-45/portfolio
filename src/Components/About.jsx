...
export default function About() {
    ...
    return (
        <>
            <div className='lg:flex lg:justify-center grid justify-center gap-10 md:gap-0 py-20 md:py-32'>
